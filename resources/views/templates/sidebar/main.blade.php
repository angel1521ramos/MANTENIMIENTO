<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-2">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Usuario</span>
                    </div>
                </div>
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <span class="menu-link">
                        ...
                        <span class="menu-title">Enviar solicitud</span>
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->is('equipo*') ? ' active' : '' }}"
                ...
                <div data-kt-menu-trigger="click" class="menu-item {{ request()->is('solicitud*') ? 'here hover show' : 'menu-accordion' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/communication/com013.svg-->
                            <span class="menu-icon">
    ...
    <div class="aside-footer flex-column-auto pt-5 pb-7 px-5" id="kt_aside_footer">
        <a href="/metronic8/demo1/../demo1/dark/documentation/getting-started.html"
            ...
            data-bs-dismiss-="click" title="Cerrar sesion">
