                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                <img src="/metronic8/demo1/assets/media/svg/card-logos/visa-dark.svg"
                                                    alt="" class="h-25px" />
                                                <img src="/metronic8/demo1/assets/media/svg/card-logos/mastercard-dark.svg"
                                                    alt="" class="h-25px" />
                                                <img src="/metronic8/demo1/assets/media/svg/card-logos/american-express-dark.svg"
                                                    alt="" class="h-25px" />
                                            </div>
                                            <!--end::Card logos-->
                                        </div>
