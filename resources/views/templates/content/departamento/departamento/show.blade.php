    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                ...
                <!--end::Card header-->
                <!--begin::Form-->
                <form id="form_departamento_show" name="form_departamento_show"
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        ...
                        <button type="submit" class="btn btn-primary" id="submit_departamento_show">Guardar
                            cambios</button>
                    </div>
                    <!--end::Card footer-->
                    <input type="hidden">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        ...
                                        <form id="form_equipo_index" name="form_equipo_index"
                                            class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                                            action="{{ route('equipo.storeDepartamento') }}">
                                            @csrf
                                            <!--begin::Scroll-->
                                            <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                ...
                                                <div class="fv-row mb-7 fv-plugins-icon-container">
                                                    ...
                                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                                        title=""
                                                        data-bs-original-title="Seleccione el tipo de dispositivo del equipo"
                                                        aria-label="Seleccione el tipo de dispositivo del equipo"></i>
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <div class="col-md-12" data-select2-id="select2-data-453-kbzx">
                                                        <div class="w-100"
                                                            ...
                                                            <select
                                                                ...
                                                                data-placeholder="SELECCIONE EL TIPO" data-select2-id="6"
                                                                tabindex="-1" aria-hidden="true">
                                                                <option data-select2-id="select2-data-21-2sb5"></option>
                                                ...
                                                <div class="fv-row mb-7 fv-plugins-icon-container">
                                                    ...
                                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                                        title=""
                                                        data-bs-original-title="Seleccione los dispositivos incluidos en el equipo"
