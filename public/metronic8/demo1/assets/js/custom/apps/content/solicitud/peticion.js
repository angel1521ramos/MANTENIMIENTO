            ...
            _form,
            {
                fields: {
                    ...
                    departamento_id: {
                        validators: {
                            notEmpty: {
                                message: ' El departamento de la solicitud es requerido'
                            }
                        }
                    },
                    observacion: {
                        validators: {
                            notEmpty: {
                                message: ' La observacion de la solicitud es requerida'
                            }
                        }
                    },
                    tipo: {
                    ...
                    estatus: {
                        validators: {
                            notEmpty: {
                                message: ' El estatus de la solicitud es requerido'
                            }
                        }
                    }
                },
